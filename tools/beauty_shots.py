...
EXAMPLES = [
    ...
    {"out": "examples/images/M57Lens-display.png",       "script": "examples/simple-lens-housing.py",     "variant": "display"},
    {"out": "examples/images/M57Lens-print.png",         "script": "examples/simple-lens-housing.py",     "variant": "print"},
