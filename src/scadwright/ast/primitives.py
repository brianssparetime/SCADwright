...
class Text(Node):
    ...
    `font` is a fontconfig family name (never a file path). With no explicit
    hint, the bbox is read from the actual glyphs when freetype-py and
    fontconfig resolve that name (content-aware: all-caps text has no
